...
import pl.dev.bkwiatkowski.domain.usecase.GetSessionByUuidUC
import java.io.File
...
class EventImageHandler(
  ...
  private val getSessionByUuidUC: GetSessionByUuidUC,
) {
  suspend fun handle(call: ApplicationCall) {
    ...
    val session = getSessionByUuidUC(
      params = GetSessionByUuidUC.Params(sessionUuid = sessionUuid),
    ).getRightOrNull() ?: run {
